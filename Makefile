...
HDRS=l2tp.h avp.h misc.h control.h call.h scheduler.h file.h aaa.h md5.h libnetlink.h l2tpv3.h
OBJS=xl2tpd.o pty.o misc.o control.o avp.o call.o network.o avpsend.o scheduler.o file.o aaa.o md5.o libnetlink.o l2tpv3.o
SRCS=${OBJS:.o=.c} ${HDRS}
